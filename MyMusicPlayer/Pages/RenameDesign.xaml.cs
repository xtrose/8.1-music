...
namespace MyMusicPlayer.Pages
{
    ...
    public partial class RenameDesign : PhoneApplicationPage
    {
                    ...
                    else
                    {
                        ...
                        if (!file.DirectoryExists("/Designs/" + TBDesignName.Text))
                        {
                            ...
                            try
                            {
                                ...
                                file.DeleteFile("/Designs/" + DesignName + "/Design.dat");
                                if (file.FileExists("/Designs/" + DesignName + "/Portrait.jpg"))
                                {
                                    ...
                                    file.DeleteFile("/Designs/" + DesignName + "/Portrait.jpg");
                                }
                                if (file.FileExists("/Designs/" + DesignName + "/Landscape.jpg"))
                                {
                                    ...
                                    file.DeleteFile("/Designs/" + DesignName + "/Landscape.jpg");
                                }
                                if (file.FileExists("/Designs/" + DesignName + "/MPBigPortrait.jpg"))
                                {
                                    ...
                                    file.DeleteFile("/Designs/" + DesignName + "/MPBigPortrait.jpg");
                                }
                                if (file.FileExists("/Designs/" + DesignName + "/MPBigLandscape.jpg"))
                                {
                                    ...
                                    file.DeleteFile("/Designs/" + DesignName + "/MPBigLandscape.jpg");
                                }
                                //Ordner löschen
