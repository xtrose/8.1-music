...
namespace MyMusicPlayer.Pages
{
    ...
    public partial class SaveDesign : PhoneApplicationPage
    {
                ...
                if (TBDesignName.Text.Length > 0)
                {
                    ...
                    if (!file.DirectoryExists("/Designs/" + TBDesignName.Text))
                    {
                        ...
                        try
                        {
                            ...
                            file.CopyFile("/Settings/Design.dat", "/Designs/" + TBDesignName.Text + "/Design.dat");
                            if (file.FileExists("/Background/Portrait.jpg"))
                            {
                                file.CopyFile("/Background/Portrait.jpg", "/Designs/" + TBDesignName.Text + "/Portrait.jpg");
                            }
                            if (file.FileExists("/Background/Landscape.jpg"))
                            {
                                file.CopyFile("/Background/Landscape.jpg", "/Designs/" + TBDesignName.Text + "/Landscape.jpg");
                            }
                            if (file.FileExists("/Background/MPBigPortrait.jpg"))
                            {
                                file.CopyFile("/Background/MPBigPortrait.jpg", "/Designs/" + TBDesignName.Text + "/MPBigPortrait.jpg");
                            }
                            if (file.FileExists("/Background/MPBigLandscape.jpg"))
                            {
                                file.CopyFile("/Background/MPBigLandscape.jpg", "/Designs/" + TBDesignName.Text + "/MPBigLandscape.jpg");
                            }
